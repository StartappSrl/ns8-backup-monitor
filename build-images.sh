...
#
# 1. Poller image: a normal, standalone container image that runs the
#    IMAP polling + parsing service. This is the "workload" referenced by
#    org.nethserver.images on the module image below.
#
pollerimage="backup-monitor-poller"

echo "Building the poller image..."
buildah bud \
